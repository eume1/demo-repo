...
#  config.vm.box = "base"
  ...
  config.vm.provision "shell", inline: <<-SHELL
    apt-get update
    apt-get install -y git build-essential python3 python-simplejson python3-pip openssl libssl-dev ca-certificates apt-transport-https curl
   ...
   stable"
    ...
    pip3 install ansible==2.3.2
    pip3 install pyopenssl==17.5.0
    pip3 install ansible-container[docker,k8s,openshift]==0.9.2
